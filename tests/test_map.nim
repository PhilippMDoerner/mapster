...
const dummyStr = "NAME"
const dummyNum = 5
const dummyFloat = 2.53
const dummyBool = true
let dummyTime = now()

type Dummy = object
const dummyValueObj = Dummy()

type DummyRef = ref object
let dummyRefObj = DummyRef()
...
suite "Testing mapExcept":
  ## All tests of `Testing map` apply by virtue of sharing an underlying implementation
  test """
    GIVEN an object type A and B that share all fields 
...
# # TODO: mapExcept test: Make sure that excepted parameters are ignored